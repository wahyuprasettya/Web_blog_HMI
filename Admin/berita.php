                                            ...
                                            <div class="row">
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <thead class="thead-dark">
                                                        ...
                                                        <th scope="col">foto_artikel</th>
                                                        <th scope="col">konten_artikel</th>
                                                        <th scope="col">penulis_artikel</th>
                                                        <th scope="col">Aksi_Ubah</th>
                                                    ...
                                                    while($data = mysqli_fetch_array($sql)){ 
                                                        ...
                                                        echo  "<td><img src='foto/artikel/".$data['image']."' width='100' height='100'></td>";
                                                        echo "<td>".$data['artikel']."</td>";
                                                        echo "<td>".$data['penulis_artikel']."</td>";
                                                        echo "<td><a href='update_artikel.php?id=".$data['id']."'>Ubah</a></td>";
                                                        echo "<td><a href='hapus_artikel.php?id=".$data['id']."'>Hapus</a></td>";
                                                        echo "</tr>";
